<?php
    ...
    include "../../../php/principal/dieta/info-nutri.php";
    ...
    <body>
        ...
        <div class="body">
            ...
            <div class="base" id="base" <?php if ($_SESSION["side"] == "FALSE"){ echo "style='margin-left: 96px;'";}?>>
                <div class="content" style="height: 1316px; padding: 64px 96px; width: 930px;">
                    <div>
                        ...
                        <div style="margin-top: 32px;">
                            <div style="display: flex; justify-content: space-between;">
                                <div>
                                    <h1 class="dieta"><b>Cliente: </b><?php echo $completo;?></h1>
                                </div>
                                <div>
                                    <h1 class="dieta"><b>Nutricionista: </b><?php echo $holder_2["Completo"];?></h1>
                                </div>
                            </div>
                            <div>
                    ...
                    <div style="margin-top: 32px;">
                        <textarea class="dieta" readonly><?php echo $holder_dieta["Texto"];?></textarea>
                    </div>
                    <div class="dieta-botao">
                        <div>
                            <a href="pdf.php"><button class="dieta">Baixar</button></a>
                        </div>
                        <div style="margin-left: 16px;">
                            <a href="edit-cliente.php"><button class="dieta">Editar</button></a>
                        </div>
                    </div>
                </div>
            <div>
