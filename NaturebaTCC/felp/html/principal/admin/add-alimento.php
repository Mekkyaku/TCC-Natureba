    ...
    if((!isset($_SESSION["logado"])) || ($_SESSION["logado"] == FALSE)){
        ...
        if ($user["tipo"] != "A"){
            ...
            if ((isset($_POST["nome"])) && (isset($_POST["categoria"])) && (isset($_POST["tag"])) && (isset($_POST["info"]))){
                ...
                $sql = "INSERT INTO `alimentos` VALUE(NULL, '$nome', '$categoria', '$tag', '$info', 'no-image.png');";
                $res = mysqli_query($con, $sql);

                    $code = "SELECT * FROM `alimentos` WHERE `nome` = '$nome';";
                    $exec = $con->query($code) or die($con->error);
            ...
            <div class="conteudo">
                <div class="conteudo-body">
                    ...
                    <div style="padding-bottom: 32px;">
                        <h2 class="admin">Preencha os campos abaixo para adicionar um alimento</h2>
                    </div>
                    <div class="adm-form">
                        <form action="add-alimento.php" autocomplete="off" enctype="multipart/form-data" method="post">
                            <div style="display: flex; padding-bottom: 16px; width: 100%;">
                                <div>
                                    <img class="adm-form" id="preview" src="../../../img/alimento/no-image.png">
                                ...
                                <div style="padding-left: 32px; padding-top: 20px; width: 100%">
                                    <div style="padding-bottom: 16px;">
                                        ...
                                        <input class="adm" id="nome" name="nome" placeholder="Nome do alimento" required type="text"> 
                                    </div>
                                    <div>
                            ...
                            <div style="padding-bottom: 16px;">
                                ...
                                <textarea class="adm" id="tag" name="tag" oninput="grown(tag)" placeholder="Tags" required></textarea>
                            </div>
                            <div style="padding-bottom: 32px;">
                                <label class="adm" for="info">Informações nutricionais</label>
                                <textarea class="adm" id="info" name="info" placeholder="Informações nutricionais" required style="height: 200px; max-height:none;"></textarea>
                            </div>
                            <div>
                                <input class="submit" id="submit" name="submit" type="submit" value="Adicionar">
                            </div>
                        </form>
                    </div>
                </div>
